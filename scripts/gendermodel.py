...
csv_file_object = csv.reader(open(data_root + 'train.csv', 'rb')) 	# Load in the csv file
...
test_file = open(data_root + 'test.csv', 'rb')
...
predictions_file = open(output_root + "gendermodel.csv", "wb")
